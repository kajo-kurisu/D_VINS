...
//            cout<<bindingName <<endl;
            if(!strcmp(bindingName,"keypoints") ||
                !strcmp(bindingName,"scores") ||
                !strcmp(bindingName,"descriptors")||
                !strcmp(bindingName,"kpts0") ||
                !strcmp(bindingName,"kpts1") ||
                !strcmp(bindingName,"desc0") ||
                !strcmp(bindingName,"desc1")||

                !strcmp(bindingName,"keypoints_r")||
                !strcmp(bindingName,"des_r")) {
                //这几个输入的第一维为动态
                dims.d[1] = 512;
//                dims.nbDims
            }
            if(!strcmp(bindingName,"matches0") || !strcmp(bindingName,"mscores0") || !strcmp(bindingName,"scores_r") )
            {
                //这几个输出的第零维为动态
                dims.d[0] = 512;
            }
